...
for (i in 1:nrow(sumario_percent)) {
  sumario_percent$Percent[i] <- scales::percent(sumario_percent$Valor[i]/totais_v[as.character(sumario_percent$Variavel[i])])
  if (sumario_percent$Variavel[i] != "Qde") {
    sumario_percent$Valor[i] <- sumario_percent$Valor[i] / 1000000
  }
}
```
